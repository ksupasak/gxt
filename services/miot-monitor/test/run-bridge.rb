...
# 1588580021  28  cms  "\xF8\x8F\x06\x1C\x00\xAE\xA5\xA5\xA5\xAF\xA5\xD0p|\x98\xB2\xE6\xF5\xBC\xFA\xBF\xF5\xF1l\x99\x10\xB2c"
...
map = {}
path = "/Users/soup/Desktop/vista120"
 ...
 Thread.fork(server.accept) do |client|
   ...
   line = "-"
    ...
    monitor_thread = Thread.new {
     ...
     if false or l.size==44 or l.size== 28 or l.size==88 or l.size == 56
         
     
     map[l.size] = File.open(File.join(path,"out-#{l.size}.txt"),'a') unless map[l.size] 
