...
if ((typeof options.help !== 'undefined') || (typeof options.key == 'undefined') || (typeof options.app == 'undefined') || (typeof options.userName == 'undefined')) {
    printHelp();
}
...
if (typeof options.expiresInSecs !== 'undefined') {
    ...
    checkForVCardFileAndGenerateToken(options.key, options.app, options.userName, options.expiresInSecs);

} else if (typeof options.expiresAt !== 'undefined') {
    console.log("expiresAt: " + options.expiresAt);
    generateTokenExpiresOnDate(options.key, options.app, options.userName, options.expiresAt);
} else {
